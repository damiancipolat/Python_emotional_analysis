...
positives_list=json.load(open('./data/spanish_positives.json'))

print("Terminos positivos:",len(positives_list))
negatives_list=json.load(open('./data/spanish_negatives.json'))
...
ouput=joblib.dump(model_bayes, './bayes_model.pkl')
